...
public class MainTopicAdapter //extends RecyclerView.Adapter<MainTopicAdapter.MainTopicViewHolder>
{
    private List<CategoryObject> categories;
    private SideMenu activity;

    public MainTopicAdapter(List<CategoryObject> categories, SideMenu activity) {
    ...
    /*@NonNull
    @Override
    public MainTopicAdapter.MainTopicViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View row= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_filter_instance,viewGroup,false);
        MainTopicAdapter.CategoryViewHolder holder = new MainTopicAdapter.CategoryViewHolder(row);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull MainTopicAdapter.MainTopicViewHolder categoryViewHolder, int i) {
